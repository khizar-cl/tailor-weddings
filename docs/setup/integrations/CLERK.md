...
| **Per environment** | One Clerk app per deployed env (e.g. `tailorweddings-staging`, `tailorweddings-prod`) | Full isolation between envs. More to manage — only worth it once QA traffic grows. |
